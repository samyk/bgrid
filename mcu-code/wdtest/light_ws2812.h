...
#define ws2812_pin  0   // Data out pin -samyk
#endif
...
void ws2812_setsingleleds_pin(uint32_t rgb, uint16_t leds, uint8_t pinmask);
...
void ws2812_sendsingle_mask(uint32_t data,uint16_t datlen,uint8_t maskhi);
